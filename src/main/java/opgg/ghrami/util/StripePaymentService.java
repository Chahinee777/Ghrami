...
public class StripePaymentService {
    ...
    // Stripe keys — loaded from ai_config.properties, never hardcoded.
    private static final String API_KEY        = ConfigManager.getInstance().getStripeSecretKey();
    public  static final String PUBLISHABLE_KEY = ConfigManager.getInstance().getStripePublishableKey();
