...
public class StripePaymentService {
    ...
    // Set this via environment variable: STRIPE_API_KEY
    private static final String API_KEY = System.getenv("STRIPE_API_KEY") != null ? System.getenv("STRIPE_API_KEY") : "sk_test_YOUR_KEY_HERE";

    // Stripe PUBLISHABLE key — safe for client-side use only (not used server-side here).
    // Set this via environment variable: STRIPE_PUBLISHABLE_KEY
    public static final String PUBLISHABLE_KEY = System.getenv("STRIPE_PUBLISHABLE_KEY") != null ? System.getenv("STRIPE_PUBLISHABLE_KEY") : "pk_test_YOUR_KEY_HERE";
