...
public class Booking {
    ...
    // ── New fields ────────────────────────────────────────────────────────────
    /** 1–5 star rating left by the student after completion. Null = not yet rated. */
    private Integer rating;
    /** Written review left by the student. May be null. */
    private String review;
    /** Last video position saved in seconds so the student can resume playback. */
    ...
    /** Convenience: returns true if student has left a rating. */
    public boolean isRated()                          { return rating != null; }
    ...
    public void setClassCategory(String classCategory){ this.classCategory = classCategory; }
    ...
    public String toString() {
        return "Booking{bookingId=" + bookingId + ", classId=" + classId +
               ", userId=" + userId + ", status=" + status +
               ", paymentStatus=" + paymentStatus + ", totalAmount=" + totalAmount +
               ", rating=" + rating + ", watchProgress=" + watchProgress + '}';
    }
}